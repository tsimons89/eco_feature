...
void Options::add_train_options(){
...
void Options::parse_train_options(int argc,char * argv[]){        
...
void Options::parse_test_options(int argc,char * argv[]){        
...
void Options::add_single_predict_options(){
...
void Options::parse_single_predict_options(int argc,char * argv[]){        
...
void Options::verify_dir_path(string path){
	struct stat info;
